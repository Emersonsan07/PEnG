...
const translations = {
    en: {
        ...
        mission_title: "Our DNA",
        mission_text: "To accelerate the transition to a circular economy by turning industrial liabilities into clean energy assets.",
        val_1: "Sustainability First", val_2: "Scientific Rigor", val_3: "Transparency",
        process_title: "How It Works",
        step1_title: "Flare Capture", step1_desc: "Collecting wasted natural gas directly at the wellhead.",
        ...
        ceo_bio: "Dr. Sarah PENG spent 15 years in chemical engineering research before founding PENG. Her breakthrough in catalytic efficiency is the core of our patent portfolio.",
        read_bio: "Read Full Bio",
        team_title: "The Minds Behind PENG",
        achieve_title: "Achievements & IP",
        ...
        partners_title: "Supported By & Partners",
        cta_title: "Join the Energy Revolution", cta_desc: "Stay updated on our latest pilot projects and investment rounds.",
        btn_subscribe: "Subscribe",
        footer_motto: "Innovating for a cleaner tomorrow.",
...
res_fuel: "Liters of Green Diesel / Day", res_co2: "Tons of CO2 Saved / Day", res_rev: "Potential Daily Revenue",
    ...
    fr: {
        ...
        mission_title: "Notre ADN",
        mission_text: "Accélérer la transition vers une économie circulaire en transformant les passifs industriels en actifs énergétiques propres.",
        val_1: "Durabilité d'Abord", val_2: "Rigueur Scientifique", val_3: "Transparence",
        process_title: "Comment ça marche",
        step1_title: "Captage des Torchères", step1_desc: "Collecte du gaz naturel gaspillé directement à la tête du puits.",
        ...
        ceo_bio: "Dr. Sarah PENG a passé 15 ans en recherche de génie chimique avant de fonder PENG. Sa percée est au cœur de notre portefeuille de brevets.",
        read_bio: "Lire la Bio",
        team_title: "Les Esprits Derrière PENG",
        achieve_title: "Réalisations & PI",
        ...
        partners_title: "Soutenu Par & Partenaires",
        cta_title: "Rejoignez la Révolution Énergétique", cta_desc: "Restez informé de nos derniers projets pilotes et cycles d'investissement.",
        btn_subscribe: "S'abonner",
        footer_motto: "Innover pour un demain plus propre.",
...
res_fuel: "Litres de Diesel Vert / Jour", res_co2: "Tonnes de CO2 Économisées / Jour", res_rev: "Revenus Quotidiens Potentiels",
    ...
    pt: {
        ...
        mission_title: "Nosso DNA",
        mission_text: "Acelerar a transição para uma economia circular transformando passivos industriais em ativos de energia limpa.",
        val_1: "Sustentabilidade Primeiro", val_2: "Rigor Científico", val_3: "Transparência",
        process_title: "Como Funciona",
        step1_title: "Captura de Queima", step1_desc: "Coleta do gás natural desperdiçado diretamente na cabeça do poço.",
        ...
        ceo_bio: "A Dra. Sarah PENG passou 15 anos em pesquisa de engenharia química antes de fundar a PENG. Sua descoberta é o núcleo de nosso portfólio.",
        read_bio: "Ler Bio Completa",
        team_title: "As Mentes por Trás da PENG",
        achieve_title: "Conquistas & PI",
        ...
        partners_title: "Apoiado Por & Parceiros",
        cta_title: "Junte-se à Revolução Energética", cta_desc: "Fique atualizado sobre nossos últimos projetos piloto e rodadas de investimento.",
        btn_subscribe: "Inscrever-se",
        footer_motto: "Inovando para um amanhã mais limpo.",
...
function calculateImpact() {
    const volume = document.getElementById('gasInput').value;
    document.getElementById('gasValue').innerText = Number(volume).toLocaleString();

    // Fórmulas Fictícias (Baseadas em rácios comuns de GTL)
    const fuel = Math.round(volume * 0.52); // 0.52L por m³
    const co2 = (volume * 0.0025).toFixed(1); // Toneladas evitadas
    const revenue = Math.round(fuel * 1.6); // $1.60 CAD por litro

    document.getElementById('fuelResult').innerText = fuel.toLocaleString();
    document.getElementById('co2Result').innerText = co2;
    document.getElementById('revResult').innerText = "$" + revenue.toLocaleString();
}
